...
var SaveUser = function () {
    ...
    if (!FieldValidation('#PasswordHash')) {
        FieldValidationAlert('#PasswordHash', 'Password is Required.', "warning");
        return;
    }
    ...
    if (password !== confirmPassword) {
        FieldValidationAlert('#ConfirmPassword', 'Password and Confirm Password do not match.', "warning");
        return;
    }
